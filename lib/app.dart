...
import 'package:my_app/src/blocs/financial/financial_report_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context) => getIt<CompanyOverviewBloc>()),
        BlocProvider(create: (context) => getIt<CompanyOwnershipBloc>()),
        BlocProvider(
          create: (context) => getIt<CompanyLeadershipBloc>(),
        ),
        BlocProvider(create: (context) => getIt<FinancialReportBloc>()),
      ],
      child: MaterialApp(
